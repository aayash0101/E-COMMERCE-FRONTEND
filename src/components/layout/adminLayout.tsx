...
const AdminLayout = () => {
  ...
  const SidebarContent = () => (
    <div className="flex h-full flex-col">
      ...
      <div className="flex h-16 items-center border-b border-gray-100 px-6">
        ...
        <span className="ml-2 rounded-md bg-purple-100 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-purple-700">
          Admin
        </span>
      </div>
      ...
      <div className="border-t border-gray-100 p-4">
        ...
        <button
          ...
          className="mt-1 flex w-full items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium text-red-500 transition hover:bg-red-50"
        >
          <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.6} d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15M12 9l-3 3m0 0l3 3m-3-3h12.75" />
          </svg>
          Sign out
        </button>
      </div>
  ...
  return (
    <div className="flex h-screen bg-gray-50/50">
      {/* Desktop sidebar */}
      <aside className="hidden w-60 flex-shrink-0 border-r border-gray-100 bg-white lg:block">
        <SidebarContent />
      </aside>
      ...
      {sidebarOpen && (
        <>
          <div
            ...
            onClick={() => setSidebarOpen(false)}
          />
          <aside className="fixed inset-y-0 left-0 z-30 w-60 border-r border-gray-100 bg-white lg:hidden">
            <SidebarContent />
          </aside>
        </>
      )}
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <div className="flex h-16 items-center border-b border-gray-100 bg-white px-4 lg:hidden">
          ...
          <span className="ml-3 font-display text-base font-bold text-ink">
            Admin Panel
          </span>
        </div>
